      ...
      <div class="card card-outline card-primary compact-card">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table id="table-departemens" class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-center text-nowrap">
                      <a href="#" class="btn btn-warning btn-sm btn-edit"
                         data-show="{{ route('departemens.show', $dept->id)}}"
                         data-update="{{ route('departemens.update', $dept->id)}}">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form action="{{ route('departemens.destroy', $dept->id)}}" method="POST" class="d-inline"
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-plus-circle mr-2"></i>Tambah Departemen
        </h5>
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-edit mr-2"></i>Edit Data Departemen
        </h5>
        <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
      </div>
