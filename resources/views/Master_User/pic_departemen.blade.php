    ...
    <div class="col-12">
      ...
      <div class="card card-outline card-primary compact-card">
        <div class="card-header">
          <h3 class="card-title">
            <i class="fas fa-user-tie mr-2"></i>PIC Departemen
          </h3>
          <div class="card-tools">
            <a href="#" class="btn btn-light btn-sm" data-toggle="modal" data-target="#modalAdd">
              <i class="fas fa-plus mr-1"></i>Tambah PIC Departemen
            </a>
          </div>
        </div>
                  ...
                  <tr>
                    ...
                    <td class="text-center text-nowrap">
                      <a href="#" class="btn btn-warning btn-sm btn-edit"
                         data-show="{{ route('dept-pics.show', $user->id) }}"
                         data-update="{{ route('dept-pics.update', $user->id) }}">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form action="{{ route('dept-pics.destroy', $user->id) }}" method="POST" class="d-inline"
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-user-plus mr-2"></i>Tambah PIC Departemen
        </h5>
        <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
      </div>

      <form action="{{ route('dept-pics.store') }}" method="POST">
        @csrf
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-edit mr-2"></i>Edit Data PIC Departemen
        </h5>
        <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
      </div>
