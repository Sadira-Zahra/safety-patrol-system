    ...
    <div class="col-12">
      ...
      <div class="card card-outline card-primary compact-card">
        <div class="card-header">
          <h3 class="card-title">
            <i class="fas fa-user-shield mr-2"></i>Safety Patroller
          </h3>
          <div class="card-tools">
            <a href="#" class="btn btn-light btn-sm" data-toggle="modal" data-target="#modalAdd">
              <i class="fas fa-plus mr-1"></i>Tambah Safety Patroller
            </a>
          </div>
        </div>
                  ...
                  <tr>
                    ...
                    <td class="text-center text-nowrap">
                      <a href="#" class="btn btn-warning btn-sm btn-edit"
                         data-show="{{ route('safety-patrollers.show', $user->id) }}"
                         data-update="{{ route('safety-patrollers.update', $user->id) }}">
                        <i class="fas fa-edit"></i>
                      </a>
                      <form action="{{ route('safety-patrollers.destroy', $user->id) }}" method="POST" class="d-inline"
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-user-plus mr-2"></i>Tambah Safety Patroller
        </h5>
        <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
      </div>

      <form action="{{ route('safety-patrollers.store') }}" method="POST">
        @csrf
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-edit mr-2"></i>Edit Data Safety Patroller
        </h5>
        <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
      </div>
