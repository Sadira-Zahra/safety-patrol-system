    ...
    <div class="col-12">
      ...
      <div class="card card-outline card-primary compact-card">
        <div class="card-header">
          <h3 class="card-title">
            <i class="fas fa-users-cog mr-2"></i>Administrator
          </h3>
          <div class="card-tools">
            <a href="#" class="btn btn-light btn-sm" data-toggle="modal" data-target="#modalAdd">
              <i class="fas fa-plus mr-1"></i>Tambah Administrator
            </a>
          </div>
        </div>
                  ...
                  <tr>
                    ...
                    <td class="text-center text-nowrap">
                      <a href="#" class="btn btn-warning btn-sm btn-edit"
                         data-show="{{ route('administrators.show', $user->id) }}"
                         data-update="{{ route('administrators.update', $user->id) }}">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-user-plus mr-2"></i>Tambah Administrator
        </h5>
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fas fa-edit mr-2"></i>Edit Data Administrator
        </h5>
        <button type="button" class="close text-white" data-dismiss="modal"><span>&times;</span></button>
      </div>
